...
<body>
	<div uk-sticky="sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky">
		<nav class="uk-navbar-container" uk-navbar="dropbar:true; mode:click">
			<div class="uk-navbar-left">
				<a class="uk-navbar-item uk-logo" href="html" uk-scroll><img src="img/logo_prov.png" alt=""></a>
	...
	<div class="uk-height-large" id="section_home" style="overflow: hidden">
		<div class="uk-height-large uk-background-cover uk-light uk-flex" uk-parallax="bgy: -100; easing: -1;" style="background-image: url('img/slideshow/3.jpeg');" id="home_parallax">
	...
	<div class="uk-section uk-section-default section_site bg-krolow" id="section_servicos">
		<div class="uk-container">
			<h1>Serviços</h1>
			<div class="uk-column-1-3@m uk-column-1-3@l">
				<div class="uk-card uk-card-default uk-card-body" uk-parallax="opacity: 0,1,1; x: -10,0,0; viewport: 0.5;">
					<h3 class="uk-card-title">Lorem ipsum</h3>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
				</div>
				<div class="uk-card uk-card-default uk-card-body uk-margin-top" uk-parallax="opacity: 0,1,1; x: -10,0,0; viewport: 0.5;">
					<h3 class="uk-card-title">Lorem ipsum</h3>
					<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
				</div>
				<div class="uk-card uk-card-default uk-card-body uk-margin-top" uk-parallax="opacity: 0,1,1; x: -10,0,0; viewport: 0.5;">
